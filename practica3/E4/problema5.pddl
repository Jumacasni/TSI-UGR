...
(:init
    ...
    (= (duration-limit a1) 50)
    (= (duration-limit a2) 70)
    (= (duration-limit a3) 70)
    (= (duration-limit a4) 1000)
    (= (duration-limit a5) 1000)
    (= (duration-limit a6) 1000)
    (= (duration-limit a7) 50)
...
(:tasks-goal
   :tasks(
       ...
       (transport-person p6 huelva)
       (transport-person p7 huelva)
       (transport-person p8 huelva)
       (transport-person p9 huelva)
