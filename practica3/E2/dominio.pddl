...
(:task mover-avion
 ...
 (:method fuel-suficiente ;; este método se escogerá para usar la acción fly siempre que el avión tenga fuel para
  ...
  :tasks (
   ...
   ; /*
   ; * MÉTODO QUE SE AÑADE PARA RESOLVER EL PROBLEMA 2
   ; */
   (:method fuel-insuficiente ;; este método se escogerá para usar la acción fly cuando el avión no tenga fufuel
                              ;; para volar desde ?c1 a ?c2
