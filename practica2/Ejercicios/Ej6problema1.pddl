(define (problem Ej6problema1)
  ...
  (:init 
    ...
    (= (capacidad-bolsillo leonardo) 1)
    (= (capacidad-bolsillo princesa) 5)
    (= (capacidad-bolsillo bruja) 4)
    (= (capacidad-bolsillo profesor) 1)
    (= (capacidad-bolsillo principe) 1)
  ...
  (:goal 
  	(and (> (puntuacion-total) 50) (> (puntuacion-player jugador1) 15) (> (puntuacion-player jugador2) 15))
  )
