(define (problem Ej4problema1)
  ...
  (:objects z1 z2 z3 z4 z5 z6 z7 z8 z9 z10 z11 z12 z13 z14 z15 z16 z17 z18 z19 z20 z21 z22 z23 z24 z25 - zona
            ...
            oscar1 oscar2 oscar3 manzana1 manzana2 manzana3 zapatillas1 bikini1 bikini2 - objetos)
  (:init
    ; Primera fila
    (conexion z1 z6 sur)
    (conexion z2 z7 sur)
    ...
    (posicion-objeto manzana3 z11)
    (posicion-objeto oscar1 z15)
    (posicion-objeto oscar2 z24)
    (posicion-objeto oscar3 z22)
