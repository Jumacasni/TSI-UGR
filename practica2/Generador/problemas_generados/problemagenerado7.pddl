(define (problem Problema7)
	...
	(:objects z1 z6 z11 z16 z21 z2 z7 z3 z8 z4 z9 z14 z19 z5 z10 z15 z20 z25 z13 z18 z23 z17 z22 z12 z24 - zona
		player1 player2 - picker
		player3 player4 - dealer
		princesa1 principe1 bruja1 profesor1 leonardo1 - personajes
		zapatillas2 rosa1 zapatillas1 manzana1 manzana2 bikini2 oscar1 rosa2 algoritmo1 bikini1 oro1 - objetos)
	(:init
		(conexion z1 z6 sur)
		...
		(= (capacidad-bolsillo bruja1) 5)
		(= (capacidad-bolsillo profesor1) 5)
		(= (capacidad-bolsillo principe1) 5)
		(= (capacidad-bolsillo leonardo1) 5)
		...
		(posicion-player player3 z6)
		(posicion-player player2 z2)
		(posicion-player player4 z7)

		(= (puntuacion-player player3) 0)
		(= (puntuacion-player player4) 0)
		...
		(orientacion-player player3 norte)
		(orientacion-player player2 norte)
		(orientacion-player player4 norte)
		...
		(mochilavacia player3)
		(mochilavacia player2)
		(mochilavacia player4)

	)

	(:goal
		(and (>= (puntuacion-player player3) 1) (>= (puntuacion-player player4) 11))
	)
